...
## 📦 О платформе (контекст, не «с нуля»)

У заказчика уже была соцсеть с базовым функционалом. В продукте (в том числе до/параллельно с моими задачами) присутствуют: лента и посты с медиа, лайки и комментарии, личные сообщения, группы, подписки, in‑app уведомления, профили, загрузка в **S3**, **PostgreSQL**. В витрине отражены **мои доработки и эксплуатация**, а не claim «написал соцсеть с нуля».
