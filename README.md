...
| # | Экран |
|---|--------|
| 1 | Главная страница (лендинг): вход и регистрация |
| 2 | Боковое меню, навигация (мобильный вид) |
| 3 | Контакты: подписки и рекомендации |
| 4 | Лента: пост с фото/видео, лайки и комментарии |
| 5 | Создание публикации (текст, теги, фото/видео) |
| 6 | Профиль: обложка, аналитика, публикации |
| 7 | Страница группы: участники, лента, настройки |
| 8 | Настройки группы: тип, права публикации, админы, invite‑ссылка |

<p align="center"><img src="docs/scren1wan.png" alt="Главная страница CLANSE" width="920" /></p>
...
<p align="center"><img src="docs/screen3.png" alt="Лента постов" width="380" /></p>
